 ...
 */
public class CombinedChartRendererEx extends CombinedChartRenderer {
    public CombinedChartRendererEx(final CombinedChart chart,
                                   final ChartAnimator animator,
            ...
            switch (order) {
                ...
                case LINE:
                    if (chart.getLineData() != null)
                        mRenderers.add(new LineChartRendererEx(chart, mAnimator, mViewPortHandler));
                    break;
                case CANDLE:
